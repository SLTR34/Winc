...
db = peewee.SqliteDatabase("/home/stefan/Documenten/GitHub/Assignments/peewee-orm/database.db")


class Ingredient(peewee.Model):
    name = peewee.CharField()
    is_vegetarian = peewee.BooleanField(column_name='is_vegetarian')
    is_vegan = peewee.BooleanField(column_name='is_vegan')
    is_glutenfree = peewee.BooleanField(column_name='is_glutenfree')
